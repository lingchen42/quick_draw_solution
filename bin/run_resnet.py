...
OUTMODELPREFIX = "resnet"
OUTHIST = "weights/resnet_hist.csv"
size = 128
batchsize = 128
nsnapshots = 1
NACCUM = 8
...
model.load_weights("weights/resnet_loss_0.658.h5")
#opt = Adam(lr=LR)
...
train_datagen = image_generator_xd(size=size, batchsize=batchsize, ks=range(NCSVS - 1), start_csv=0, dp_dir=DP_DIR)
